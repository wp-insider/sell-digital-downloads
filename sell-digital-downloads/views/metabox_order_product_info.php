...
<table class="form-table">
	<tr valign="top">
       <th scope="row"><strong><label for="product_id"><?php echo __('ID:','sell-digital-downloads'); ?></label><strong></th>
       <td>
       		<input type="number" value="<?php echo $product_info['id']; ?>" id="product_id" name="product_id" min="0" required />
        </td>
    </tr>
    <tr valign="top">
       <th scope="row"><strong><label for="product_name"><?php echo __('Name:','sell-digital-downloads'); ?></label><strong></th>
       <td>
       		<input type="text" value="<?php echo $product_info['name']; ?>" id="product_name" name="product_name"  class="disabled" disabled/>
        </td>
    </tr>
    <tr valign="top">
       <th scope="row"><strong><label for="product_downloads"><?php echo __('Downloads:','sell-digital-downloads'); ?></label><strong></th>
       <td>
    ...
    <tr valign="top">
       <th scope="row"><strong><label for="download_url" id="download_url_label"><?php echo __('Download URL:','sell-digital-downloads'); ?></label><strong></th>
       <td>
       		<input type="url" value="<?php echo $product_info['download_url']; ?>" id="download_url" name="download_url"  class="disabled" disabled />
        </td>
    </tr>
    <tr valign="top">
       <th scope="row"><strong><label for="product_link_status"><?php echo __('Link Status:','sell-digital-downloads'); ?></label><strong></th>
       <td>
